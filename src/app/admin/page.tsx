import { getCurrentProfile, getActiveWarzone } from "@/lib/data";
...
export default async function AdminPage() {
  const [profile, warzone] = await Promise.all([getCurrentProfile(), getActiveWarzone()]);
  ...
  return (
    <main className="wrap">
      ...
      <CampaignAdmin activeWarzoneName={warzone?.name ?? null} />
      <AdminPanels />
    </main>
  );
}
